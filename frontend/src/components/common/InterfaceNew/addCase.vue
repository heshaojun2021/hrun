<template>
  ...
  <div style="margin: 10px" ref="addCase">
  ...
  <el-form :rules="rulesinterface" ref="interfaceRef" :model="caseInfo">
    ...
    <el-col :span="6" style="text-align: right;">
      ...
      <el-button @click="addClick" type="primary" icon="el-icon-edit-outline">保存</el-button>
    </el-col>
  </el-row>
    ...
    <el-col :span="14">
      <el-form-item label="接口名称" prop="name" >
        <el-input v-model="caseInfo.name" placeholder="请输入接口名称" clearable style="width: 345px"/>
      </el-form-item>
    </el-col>
    <el-col :span="14">
